...
LLM-based metrics and robustness tests that use LLM perturbations require either a local [vLLM](https://docs.vllm.ai/) server or a [TogetherAI](https://www.together.ai/) API key.
